...
## L3 智能体时代：从「会聊天」到「会做事」（2026.08）

2026 年 8 月沙利文峰会（弗若斯特沙利文 & 头豹研究院《2026 年 AI 进阶与飞跃白皮书》）给出产业阶段判断：**「行业已无可置疑地进入 AI 的 L3 时代」**（阶跃星辰 CTO 朱亦博）。^[raw/articles/nbd-l3-agent-era-2026-08-09.md]

- **L3 定义**：源自 OpenAI AGI 路线图五级——L1 聊天机器人 → L2 推理者 → **L3 智能体（能思考还能行动）** → L4 创新者 → L5 组织者；时代起点是 2025 下半年 Claude Code 问世
- **企业部署现状**：57.3% 受访企业已在生产环境运行智能体，但**任何单一业务职能规模化部署占比均未超过 10%**——处于试点与局部部署阶段，距跨职能端到端接管仍有差距
- **中国大模型落地场景结构**：互联网 31.8%、金融 14.7%、工业制造 12.2%、消费零售 8.1%、教育 6.5%（合计 73.3%）
- **Token 需求爆发**：中国日均 Token 调用量从 2024 年初约 1000 亿 → 2025 年底 100 万亿 → 2026 年 3 月突破 140 万亿（两年增长超千倍）；推理侧成为 2026 年智能算力主要增量来源
- **竞争焦点迁移**：2024 看模型能力 → 2025 看 Agent 推动 → 2026 看**谁能以更合理成本把 AI 稳定部署进复杂业务流程**
- 未来四大机会：大模型（认知底座）、Agent（数字任务执行）、物理 AI（真实环境）、AI4S（科研重构）
